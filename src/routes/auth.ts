...
auth.get('/verify', async (c) => {
  ...
  if (!user) {
    ...
    user = { id: userId, email, plan: 'free', check_limit: 10, api_key_hash: null, webhook_signing_secret: '', timezone: 'UTC', status_page_title: '', status_page_logo_url: '', status_page_description: '', status_page_public: 0, created_at: timestamp, updated_at: timestamp };
